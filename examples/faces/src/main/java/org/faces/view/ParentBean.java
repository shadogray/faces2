...
public class ParentBean implements Serializable {
	...
	public String update() {
		...
		try {
			if (this.id == null) {
				...
				this.entityManager.merge(this.parent);
	...
	public String delete() {
		...
		try {
			Parent deletableEntity = findById(getId());
	...
	public Converter getConverter() {
		...
		final ParentBean ejbProxy = this.sessionContext
				.getBusinessObject(ParentBean.class);
